# LAB Build a Power Pages portal

Source: PL-200

In this lab you will provision a Power Pages site and explore Power Pages portal and expose Milestone data to customers.
...
### Task 1 - Create a Power Pages site

1. Navigate to the [Power Pages portal](https://make.powerpages.microsoft.com/) `https://make.powerpages.microsoft.com/` and sign in with your Microsoft 365 credentials if prompted.

1. Use the Environment selector to switch to your **Dev** environment.
...
![Power Pages portal deployed.](https://raw.githubusercontent.com/MicrosoftLearning/PL-200-Power-Platform-Functional-Consultant/master/Instructions/media/portal-deployed.png)
...
1. Navigate to the [Power Pages portal](https://make.powerpages.microsoft.com/) `https://make.powerpages.microsoft.com/`.
...
1. Click **Azure AD**. This will sign you in with your Microsoft 365 credentials.
    ...
    ![Power Pages permissions requested.](https://microsoftlearning.github.io/PL-200-Power-Platform-Functional-Consultant/Instructions/media/portal-permissions-requested.png)
...
1. Edit **Edit**.
2. 
    ![Power Pages designer.](https://microsoftlearning.github.io/PL-200-Power-Platform-Functional-Consultant/Instructions/media/power-pages-designer.png)
...
1. Enter **Fabrikam Environmental**.
    ...
    ![Power Pages portal edits.](https://microsoftlearning.github.io/PL-200-Power-Platform-Functional-Consultant/Instructions/media/designer-edit.png)
...
1. Click **Save**.
    ...
    ![Power Pages table permissions.](https://microsoftlearning.github.io/PL-200-Power-Platform-Functional-Consultant/Instructions/media/portal-table-permissions.png)
...
1. Select **Start from blank**.
    ...
    ![Add page to site.](https://microsoftlearning.github.io/PL-200-Power-Platform-Functional-Consultant/Instructions/media/portal-add-page.png)
